...
objs = json.load(open('../dataset/VAD/objects.json'))
pres = json.load(open('../dataset/VAD/predicates.json'))
...
pk.dump({'rel': list(rel_to_pos.keys())}, open('../dataset/VAD/rels.pk', 'wb'))
pk.dump(clauses, open('../dataset/VAD/clauses.pk', 'wb'))
pk.dump({'obj2id': dict(var_pool.obj2id), 'id2obj': dict(var_pool.id2obj)},
        open('../dataset/VAD/var_pool.pk', 'wb'))
pk.dump(pres, open('../dataset/VAD/predicates.pk', 'wb'))
pk.dump(objs, open('../dataset/VAD/objects.pk', 'wb'))
