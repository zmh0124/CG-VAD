...
for i in range(len(sorted_relations)):
    english.append([predicates[sorted_relations[i][0]], sorted_relations[i][0], box_names[sorted_relations[i][1]],
                    sorted_relations[i][1], len(all_relations_bbox[sorted_relations[i]])])
print(english)
