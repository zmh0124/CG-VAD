...
preprocessed_annotation_train_raw = pk.load(open('../dataset/VAD/preprocessed_annotation_train.pk', 'rb'))
preprocessed_annotation_test_raw = pk.load(open('../dataset/VAD/preprocessed_annotation_test.pk', 'rb'))
...
pk.dump(clearn_train, open('../dataset/VAD/preprocessed_annotation_train.pk', 'wb'))
pk.dump(clearn_test, open('../dataset/VAD/preprocessed_annotation_test.pk', 'wb'))